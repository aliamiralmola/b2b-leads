        ...
        <div className="min-h-screen bg-black text-zinc-50 font-sans selection:bg-indigo-500/30 py-20 px-4">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
                    {/* Email */}
                    <Card className="bg-zinc-950/80 border-white/10 hover:border-indigo-500/50 transition-colors h-full">
                        <CardContent className="pt-6 flex flex-col h-full">
                            ...
                            <p className="text-zinc-400 mb-6 flex-1">Drop us a line anytime and we&apos;ll get back to you as soon as possible.</p>
                            <a
                    ...
                    <Card className="bg-zinc-950/80 border-white/10 hover:border-indigo-500/50 transition-colors h-full">
                        <CardContent className="pt-6 flex flex-col h-full">
                            ...
                            <p className="text-zinc-400 mb-2 flex-1">Monday – Friday</p>
                            <p className="text-white font-semibold">09:00 – 18:00 UTC</p>
                            <p className="text-zinc-500 text-xs mt-1">(12:00 – 21:00 GST · 05:00 – 14:00 EDT)</p>
                            <p className="text-zinc-500 text-sm mt-4 italic">Typical response within 24 hours</p>
                        </CardContent>
                    </Card>

                    {/* Live Chat */}
                    <Card className="bg-zinc-950/80 border-white/10 hover:border-emerald-500/50 transition-colors h-full">
                        <CardContent className="pt-6 flex flex-col h-full">
                            ...
                            <p className="text-zinc-400 mb-6 flex-1">Chat with us directly inside the platform dashboard for instant support.</p>
                            <Link
                                href="/dashboard"
