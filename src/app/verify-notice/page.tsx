    ...
    return (
        <div className="min-h-screen bg-background flex flex-col justify-center py-12 sm:px-6 lg:px-8 selection:bg-indigo-500/30">
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-card border border-border py-8 px-4 shadow-2xl sm:rounded-2xl sm:px-10 text-center">
                    <div className="space-y-6">
                        <p className="text-muted-foreground leading-relaxed">
                            Account Created! Please check <span className="font-semibold text-foreground">{email ? decodeURIComponent(email) : 'your email'}</span> and click the verification link to activate your b2bleads account.
                        </p>
